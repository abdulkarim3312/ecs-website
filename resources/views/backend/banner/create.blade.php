                ...
                <div class="card-body">
                    <form method="post" action="{{ route('banner.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" name="title" class="form-control" value="{{ old('title') }}" id="title" placeholder="Title (Optional)">
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            <label for="file">Upload photo; Suggested size → Width: 1157px and Height: 307px</label>
