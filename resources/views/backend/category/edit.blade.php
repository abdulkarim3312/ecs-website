                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control my-editor" name="description" id="description" rows="3">{{ ($category->bn_description()) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control my-editor" name="en_description" id="en_description" rows="3">{{ strip_tags($category->en_description()) }}</textarea>
