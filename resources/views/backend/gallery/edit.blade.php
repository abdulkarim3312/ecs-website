        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom border-dashed d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('gallery.index') }}" class="btn btn-primary btn-sm btn-back">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('gallery.update', $gallery->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control my-editor" name="description" id="description" rows="3">{!! $gallery->description !!}</textarea>
                        ...
                        <div class="form-group">
                            <img src="{{config('app.url')}}{{ $gallery->image }}" width="120" />
                            <br/><br/><br/>
