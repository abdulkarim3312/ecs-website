    ...
    <div class="page-title-box">
        <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="font-18 mb-0">Party </h4>
            </div>
            <div class="text-end">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <span class="fw-bold me-3">Party List</span>
                    </div>
                    @can('create-party')
                        <a href="{{ route('party.create') }}" class="btn btn-primary btn-sm">
...
<script>
    var dataTable = $('#responsive-datatable').DataTable({
        ...
        columns: [
            ...
            { data: 'bn_president', name: 'bn_president'},
            { data: 'bn_secretary', name: 'bn_secretary'},
