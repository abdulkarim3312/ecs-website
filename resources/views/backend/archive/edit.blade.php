                ...
                <div class="card-body">
                    <form method="post" action="{{ route('archive.update', $archive->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description" rows="3">{{ strip_tags($archive->bn_description()) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="en_description" id="en_description" rows="3">{{ strip_tags($archive->en_description()) }}</textarea>
