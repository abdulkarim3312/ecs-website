    ...
    <div class="page-title-box">
        <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="font-18 mb-0">Notice </h4>
            </div>
            <div class="text-end">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <span class="fw-bold me-3">Notice List</span>
                    </div>
                    @can('create-notice')
...
<script>
    var dataTable = $('#responsive-datatable').DataTable({
        ...
        columns: [
            ...
            { data: 'bn_title', name: 'bn_title', width: '30%' },
            { data: 'en_title', name: 'en_title', width: '30%' },
            { data: 'published_by', name: 'published_by' },
            { data: 'created_at', name: 'created_at' },
            { data: 'action', title: 'Action', orderable: false, searchable: false, width: '10%' }
        ]
    });
    ...
    $(document).ready(function () {
        $(document).on('submit', '.delete-form', function (e) {
            ...
            const url = '{{ route("notice.destroy", ":id") }}'.replace(':id', id);
