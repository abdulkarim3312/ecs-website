    ...
    <div class="page-title-box">
        <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="font-18 mb-0">Video</h4>
            </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom border-dashed d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('video.index') }}" class="btn btn-primary btn-sm btn-back">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('video.store') }}">
                        ...
                        <div class="form-group">
                            <input type="text" name="link" class="form-control @error('link') is-invalid @enderror" id="link" placeholder="Youtube URL" value="{{ old('link') }}">
                            @error('link')
                        ...
                        <a href="{{ route('video.index') }}" class="btn btn-success mdi mdi-undo-variant width-sm mx-1">Back</a>
                    </form>
                </div>
            </div> 
        </div>
