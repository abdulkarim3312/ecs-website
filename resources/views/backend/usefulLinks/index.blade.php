    ...
    <div class="page-title-box">
        <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="font-18 mb-0">Use full link </h4>
            </div>
            <div class="text-end">
                <ol class="breadcrumb m-0 py-0">
                    <li class="breadcrumb-item">Dashboard</li>
                    <li class="breadcrumb-item active">Use full link List</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <span class="fw-bold me-3">Use full link List</span>
                    </div>

                    <a href="{{ route('link.create') }}" class="btn btn-primary btn-sm">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('submit', '.delete-form', function (e) {
            ...
            const url = '{{ route("link.destroy", ":id") }}'.replace(':id', id);
