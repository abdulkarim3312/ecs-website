    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('link.update', $usefulLink->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="title">Title</label>
                            <input type="text" name="title" class="form-control" id="title" value="{{ $usefulLink->title ?? '' }}">
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="link" class="form-control" id="link" value="{{ $usefulLink->link ?? '' }}">
                            @if ($errors->has('link'))
                                <span class="help-block">
